...
// у меня нет метода регистрации для админа, сейчас вскрылась эта проблема: система создана так, что создавать новые аккаунты может только role = Observer, но после вот такого ребута